...
<body>
    <h1>Vpišite http://192.168.4.1/1 za vklop LED diode ali http://192.168.4.1/0 za izklop, t.j. /1 ali /0 na koncu.</h1>
</body>
</html>
...
// korenski ("root") naslov našega strežnika na esp32 moudlu, (npr. http://192.168.4.1/) - request "/" pomeni korenski naslov
void handle_root() {
...
// tu določimo, kaj se dogodi, če uporabnik vpiše
// zahtevo "/1" (npr. http://192.168.4.1/1) - request "/1"
void handle_1() {
...
// tu določimo, kaj se dogodi, če uporabnik vpiše
// zahtevo "/0" (npr. http://192.168.4.1/0) - request "/0"
void handle_0() {
...
void setup() {
  ...
  WiFi.softAP(ssid, password);  // ustvarimo WiFi dostopno točko (Access Point) z imenom "esp32_1" in geslom "12345678"

  delay(100); // počakamo 100ms, da se dostopna točka vzpostavi
